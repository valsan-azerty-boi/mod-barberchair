...
char const* ModBarberchairScript::GetTechnicalString(LocaleConstant locale, int techMsgId)
{
    if (locale == LOCALE_deDE)
    {
        switch (techMsgId)
        {
            case TECH_MSG_ERR_MONEY:
                return "|cffff0000Sie haben nicht genug Geld für diesen Dienst.|r";
            case TECH_MSG_CANCEL:
                return "Abbrechen";
            default:
                return "<Fehlende Übersetzung>";
        }
    ...
    else if (locale == LOCALE_esES || locale == LOCALE_esMX)
    {
        ...
        {
            case TECH_MSG_ERR_MONEY:
                return "|cffff0000No tiene suficiente dinero para este servicio.|r";
            case TECH_MSG_CANCEL:
                return "Cancelar";
            default:
                return "<Traducción faltante>";
    ...
    else if (locale == LOCALE_frFR)
    {
        ...
        {
            case TECH_MSG_ERR_MONEY:
                return "|cffff0000Vous n'avez pas assez d'argent pour ce service.|r";
            case TECH_MSG_CANCEL:
                return "Annuler";
            default:
                return "<Traduction manquante>";
    ...
    else
    {
        ...
        {
            case TECH_MSG_ERR_MONEY:
                return "|cffff0000You do not have enough money for this service.|r";
            case TECH_MSG_CANCEL:
                return "Cancel";
            default:
                return "<Missing translation>";
